...
test_lab7() {
  ...
  local heap_path=${WORKDIR}/src/tiger/runtime/gc/heap/heap.cc
  local score=0
  local full_score=1
  local testcase_name
  ...
  for testcase in "$testcase_dir"/*.tig; do
    ...
    ./tiger-compiler "$testcase" &>/dev/null
# g++ -Wl,--wrap,getchar -m64 ../testdata/lab7/testcases/bigger_tree.tig.s ../src/tiger/runtime/runtime.cc ../src/tiger/runtime/gc/heap/heap.cc -o test.out
# ./test_codegen ../testdata/lab7/testcases/bigger_tree.tig
